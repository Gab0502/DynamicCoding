...
media_1_5 = media_arredondada(1,5)
media_2_4 = media_arredondada(2,4)
media_3_3 = media_arredondada(3,3)

media_9_5 = media_arredondada(9,5)
...
def numero_do_meio(lista,comeco,fim):
    return lista[media_arredondada(comeco,fim)]
